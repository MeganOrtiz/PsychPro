...
const subjectiveMeasures: MeasureRow[] = [
  ...
  { test: "Conners-3", fullName: "Conners, Third Edition", usedFor: "ADHD and related behavioral, emotional, and academic problems in children", domains: "Inattention; Hyperactivity / Impulsivity; Learning Problems; Executive Functioning; Aggression; Peer Relations", indices: "ADHD Index; DSM-5 Symptom Scales (Inattentive, Hyperactive-Impulsive); Content Scales: Inattention, Hyperactivity / Impulsivity, Learning Problems, Executive Functioning, Aggression, Peer Relations; Validity Scales; Parent, Teacher, and Self-Report forms", ageRange: "6:0 – 18:11" },
...
async function main() {
  ...
  await replaceFlashcards(subjectiveId, [
    ...
    { question: "What is the Conners-3 used for and what informant forms are available?", answer: "The Conners-3 assesses ADHD and related behavioral, emotional, and academic problems in children (6:0 – 18:11). It includes an ADHD Index, DSM-5 Symptom Scales, and Content Scales for inattention, hyperactivity / impulsivity, learning problems, executive functioning, aggression, and peer relations. Forms: Parent, Teacher, and Self-Report.", difficulty: "medium" },
