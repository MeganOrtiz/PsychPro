...
- [PsychPro MCP protected-resource](psychpro-mcp-protected-resource.md) — "Claude can't access" = RFC 9728 /.well-known/oauth-protected-resource missing from artifact.toml paths → SPA serves HTML; add route + paths entry.
