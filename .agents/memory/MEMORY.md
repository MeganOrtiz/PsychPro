...
- [Design system lock](psychpro-design-lock.md) — two guardrails still enforce the system, now locked to the WHITE/luminous three-material system (site-wide, landing included); update locks in same commit as intentional changes.
...
- [Landing Brain Lab brain](psychpro-landing-brain-cutout.md) — historical (2026-07-22: Brain Lab promo image removed entirely, text-only solo card); glowing-brain rejection still stands; lateral-glow.png cutout exists unused.
- [Landing hero ink+chrome](psychpro-landing-hero-ink-chrome.md) — CURRENT hero (2026-07-22): full-bleed blue ink-cloud band + chrome brain cutout overhanging; guardrail pins it; splash-brain assets deleted.
