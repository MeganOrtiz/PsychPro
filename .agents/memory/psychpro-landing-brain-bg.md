...
- Owner-ACCEPTED brain placement (July 8, 2026): a transparent cutout of a NEW owner-supplied glowing brain (hero-brain-glow.png) sits in the landing hero above the wordmark as a content <img> — brain-as-cutout-in-hero is the approved pattern; brain-baked-into-bg is not.
...
- Resolution (same day): owner chose the brainless CENTERED 16:9 crop of that same composite as the SITE-WIDE background — it now lives as the canonical psychpro-smoke-bg-hq.jpeg (3023x1700 native crop, no upscale). The full portrait source remains in attached_assets if a recut is ever needed.
