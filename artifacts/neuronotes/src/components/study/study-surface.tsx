...
function surfaceStyles(tone: StudyTone): CSSProperties {
  switch (tone) {
    case "dark":
      ...
      return {
        background:
          "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.09) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, rgba(15, 81, 97, 0.80), rgba(8, 57, 69, 0.90))",
    ...
    case "accent":
      ...
      return {
        background:
          "radial-gradient(140% 92% at 50% 0%, rgba(118,228,247,0.18) 0%, rgba(118,228,247,0.00) 60%), linear-gradient(135deg, rgba(37,148,173,0.64), rgba(21, 111, 133, 0.76))",
    ...
    case "card-front":
      ...
      return {
        background:
          "radial-gradient(120% 104% at 50% 38%, rgba(118,228,247,0.22) 0%, rgba(46, 147, 172,0.52) 42%, rgba(17, 92, 111, 0.76) 100%)",
        borderColor: "rgba(118,228,247,0.32)",
        backdropFilter: "blur(20px) saturate(140%)",
        WebkitBackdropFilter: "blur(20px) saturate(140%)",
        boxShadow:
    ...
    default:
      ...
      return {
        background:
          "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.06) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, rgba(12, 72, 87, 0.74), rgba(7, 52, 63, 0.85))",
...
function pillStyles(tone: StudyTone, brand?: boolean): CSSProperties {
  ...
  return brand
    ...
    : {
        ...
        color: P.surf,
        borderColor: "rgba(94, 179, 200,0.30)",
      };
}
