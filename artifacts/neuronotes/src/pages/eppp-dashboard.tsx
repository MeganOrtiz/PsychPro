...
.epd-head {
  ...
  background: linear-gradient(135deg, rgba(12, 72, 93, 0.96), rgba(12, 66, 84, 0.92));
...
.epd-head-shade {
  ...
  inset: 0;
  background:
    radial-gradient(circle at 50% 52%, rgba(12, 72, 93, 0.12) 0%, rgba(12, 72, 93, 0.62) 55%, rgba(12, 72, 93, 0.94) 100%),
    linear-gradient(90deg, rgba(12, 72, 93, 0.96), rgba(12, 72, 93, 0.28) 48%, rgba(12, 72, 93, 0.96));
}
.epd-title {
  position: relative;
  z-index: 1;
