      ...
      <div className="min-h-full study-page-bg" data-testid="exam-results">
        ...
        <div className="text-center mb-8">
          <div
            ...
            style={{
              background: passed ? `linear-gradient(135deg, #1f5b70, ${P.tealDeep})` : "rgba(244,180,98,0.18)",
        ...
        <div className="max-w-2xl mx-auto p-4 md:p-6 lg:p-8">
          ...
          <section
            ...
            style={{
              ...
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.14) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, rgba(12, 68, 87, 0.81), rgba(7, 49, 63, 0.90))",
      ...
      <div className="space-y-2.5 mb-6">
        {[
          ...
          if (!isAnswered) {
            ...
            style = {
              background:
                "linear-gradient(to bottom, rgba(19, 108, 139, 0.78), rgba(12, 68, 87, 0.86))",
              borderColor: `${P.surf}55`,
              color: P.cloud,
            ...
            style = {
              background: `linear-gradient(to bottom, #1f5b70, ${P.tealDeep})`,
