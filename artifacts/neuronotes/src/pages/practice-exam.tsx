...
export default function PracticeExamPage({ params }: Props) {
        ...
        <div className={`grid gap-3 mb-6 ${availableCounts.length === 2 ? "grid-cols-2" : "grid-cols-1"}`}>
          {availableCounts.length === 0 && examAvailable > 0 && (
            <button
              ...
              className="rounded-md border p-5 text-left transition-all hover:-translate-y-0.5 bg-card"
              style={{
        ...
        <div className="max-w-2xl mx-auto p-4 md:p-6 lg:p-8">
          ...
          <section
            ...
            style={{
              ...
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.14) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, hsl(var(--surf-hue) 98% 19% / 0.81), hsl(var(--surf-hue) 98% 14% / 0.90))",
          ...
          >
            <header className="flex items-start gap-3 mb-3">
              <div
                ...
                style={{ background: `hsl(var(--surf-hue) 79% 58% / 0.18)`, border: `1px solid ${P.surf}55` }}
              >
  ...
  return (
    <div className="min-h-full study-page-bg" data-testid="exam-page">
      ...
      <div className="w-full rounded-full h-1.5 mb-6 overflow-hidden" style={{ background: "hsl(var(--surf-hue) 88% 48% / 0.12)" }}>
        <div
      ...
      <div className="space-y-2.5 mb-6">
        {[
          ...
          if (!isAnswered) {
            ...
            style = {
              background:
                "linear-gradient(to bottom, hsl(var(--surf-hue) 98% 31% / 0.78), hsl(var(--surf-hue) 98% 19% / 0.86))",
              borderColor: `${P.surf}55`,
              color: P.cloud,
