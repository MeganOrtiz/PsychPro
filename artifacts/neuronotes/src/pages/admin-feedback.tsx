              ...
              <div className="flex gap-2">
                ...
                {entry.status !== "resolved" && (
                  <button
                    ...
                    className="text-xs text-green-700 dark:text-green-400 hover:text-green-800 border border-green-200 dark:border-green-800 rounded-lg px-2.5 py-1 transition-colors flex items-center gap-1"
                  >
