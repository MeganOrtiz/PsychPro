      ...
      <div className="min-h-full study-page-bg" data-testid="mastery-locked">
        <div className="max-w-lg mx-auto p-4 md:p-6 lg:p-8 text-center">
          <div
            ...
            style={{
              background: "linear-gradient(135deg, hsl(var(--surf-hue) 98% 31% / 0.9), hsl(var(--surf-hue) 98% 19% / 0.95))",
        ...
        <div className="space-y-2.5 mb-6">
          {[
            ...
            if (!isAnswered) {
              ...
              style = {
                background: "linear-gradient(135deg, hsl(var(--surf-hue) 98% 31% / 0.78), hsl(var(--surf-hue) 98% 19% / 0.86))",
                borderColor: `${P.surf}55`,
                color: P.cloud,
