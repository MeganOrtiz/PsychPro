      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="relative mb-4">
            <div className="w-full rounded-full h-1.5 mb-8 overflow-hidden" style={{ background: "hsl(var(--surf-hue) 88% 48% / 0.12)" }}>
              <div
          ...
          {onLastPreviewCard && (
            ...
            >
              <div
                ...
                style={{ background: `hsl(var(--surf-hue) 79% 58% / 0.25)`, border: `1px solid ${P.surf}55` }}
              >
