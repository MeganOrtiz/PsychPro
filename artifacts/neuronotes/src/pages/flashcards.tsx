      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="relative mb-4">
            <div className="w-full rounded-full h-1.5 mb-8 overflow-hidden" style={{ background: "rgba(47, 168, 198,0.12)" }}>
              <div
          ...
          {onLastPreviewCard && (
            ...
            >
              <div
                ...
                style={{ background: `rgba(94, 179, 200,0.25)`, border: `1px solid ${P.surf}55` }}
              >
