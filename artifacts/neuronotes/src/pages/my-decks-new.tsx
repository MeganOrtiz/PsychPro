                  ...
                  {showExamControls && (
                    <>
                      ...
                      <button
                        ...
                        className={`w-full flex items-center justify-between gap-2 rounded-md border px-3 py-2.5 text-sm transition-colors ${
                  ...
                  <div>
                    {file ? (
                      <div className="flex items-center gap-3 p-4 bg-primary/5 border border-primary/20 rounded-xl">
                        ...
                        <button type="button" onClick={removeFile} className="p-1 rounded-md hover:bg-muted transition-colors">
