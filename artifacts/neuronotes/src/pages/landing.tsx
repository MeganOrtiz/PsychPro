...
const C = {
  ...
  bg: "#082833",
  bgPanel: "rgba(12, 68, 87, 0.82)",
  bgPanelStrong: "rgba(7, 49, 63, 0.90)",
...
.landing-nav {
  ...
  background: linear-gradient(180deg, rgba(8, 41, 52, 0.58), rgba(8, 41, 52, 0.26));
...
.landing-blurb {
  ...
  text-shadow: 0 1px 12px rgba(2, 18, 23, 0.55);
}
.landing-cta-row {
  display: flex;
  flex-wrap: wrap;
...
.landing-section-sub {
  ...
  text-shadow: 0 1px 10px rgba(2, 18, 23, 0.45);
}
...
.landing-feature-title {
  ...
  line-height: 1.3;
  color: #ffffff;
  text-shadow: 0 1px 10px rgba(2, 18, 23, 0.55);
}
...
.landing-science-item {
  ...
  border-radius: 16px;
  border: 1px solid ${C.hairline};
  background: linear-gradient(180deg, rgba(12, 68, 87, 0.82), rgba(7, 49, 63, 0.90));
...
.landing-founder-card {
  ...
  background: linear-gradient(150deg, rgba(12, 68, 87, 0.85), rgba(7, 49, 63, 0.90));
...
.landing-dash-card {
  ...
  background: linear-gradient(145deg, rgba(12, 68, 87, 0.84), rgba(7, 49, 63, 0.90));
  border: 1px solid ${C.hairlineStrong};
...
.landing-scholar-card {
  ...
  background: linear-gradient(150deg, rgba(12, 68, 87, 0.86), rgba(7, 49, 63, 0.90));
  border: 1px solid ${C.hairlineStrong};
...
.landing-footer {
  ...
  background: linear-gradient(180deg, rgba(8, 41, 52, 0.32), rgba(8, 41, 52, 0.7));
  backdrop-filter: blur(8px);
}
