        ...
        <>
          ...
          <div className="space-y-2.5 mb-6">
            {options.map(({ key, text }) => {
              ...
              if (!selected) {
                ...
                style = {
                  background:
                    "linear-gradient(135deg, hsl(var(--surf-hue) 100% 22% / 0.78), hsl(var(--surf-hue) 98% 13% / 0.86))",
          ...
          {showExplanation && selected && selected !== current.correctAnswer && (
            <div
              ...
              style={{
                background:
                  "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.12) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, hsl(var(--surf-hue) 98% 19% / 0.79), hsl(var(--surf-hue) 98% 14% / 0.90))",
