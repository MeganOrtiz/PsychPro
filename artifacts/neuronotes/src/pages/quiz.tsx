        ...
        <>
          ...
          <div className="space-y-2.5 mb-6">
            {options.map(({ key, text }) => {
              ...
              if (!selected) {
                ...
                style = {
                  background:
                    "linear-gradient(135deg, rgba(12,86,102,0.78), rgba(8,50,59,0.86))",
          ...
          {showExplanation && selected && selected !== current.correctAnswer && (
            <div
              ...
              style={{
                background:
                  "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.12) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, rgba(12,73,87,0.79), rgba(7,52,63,0.90))",
