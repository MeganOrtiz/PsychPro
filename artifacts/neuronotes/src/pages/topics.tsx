...
function CourseRailButton({
  ...
  const idleBg = "linear-gradient(135deg, rgba(19, 108, 139, 0.78), rgba(12, 68, 87, 0.86))";
  const activeBg = "linear-gradient(135deg, rgba(118,228,247,0.15), rgba(19, 108, 139, 0.90))";
  ...
  return (
    ...
    >
      <span
        ...
        style={{
          background:
            "radial-gradient(circle at 50% 40%, rgba(118,228,247,0.18), rgba(19, 108, 139, 0.55) 70%)",
    ...
    <div data-testid={`course-pane-${group.name.toLowerCase().replace(/[^a-z0-9]+/g, "-")}`}>
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(circle at 50% 40%, rgba(58,224,236,0.18), rgba(19, 108, 139, 0.65) 70%)",
...
function CourseMasteryButton({ group }: { group: { name: string; items: Topic[] } }) {
  ...
  const lockedBg = "linear-gradient(135deg, rgba(19, 108, 139, 0.78), rgba(12, 68, 87, 0.86))";
  const unlockedBg = "linear-gradient(135deg, rgba(118,228,247,0.16), rgba(19, 108, 139, 0.92))";
...
function TopicCard({ topic, onClick, showCategory }: TopicCardProps) {
  ...
  return (
    <button
      ...
      style={{
        background:
          "linear-gradient(135deg, rgba(19, 108, 139, 0.78), rgba(12, 68, 87, 0.86))",
