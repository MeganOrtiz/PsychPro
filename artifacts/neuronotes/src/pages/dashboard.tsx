      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 pt-4 md:pt-6 lg:pt-8 pb-4 md:pb-6 lg:pb-8">
        {isOverLimit && (
          <div
            ...
            style={{
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.16) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, rgba(11,54,70,0.83), rgba(6,33,46,0.90))",
        ...
        {isApproachingLimit && (
          <div
            ...
            style={{
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.14) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, rgba(11,54,70,0.79), rgba(6,33,46,0.90))",
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={activitySeries} margin={{ top: 8, right: 8, bottom: 0, left: -22 }}>
                    ...
                    <Tooltip
                      ...
                      contentStyle={{
                        background: "rgba(14,78,100,0.92)",
