      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 pt-4 md:pt-6 lg:pt-8 pb-4 md:pb-6 lg:pb-8">
        {isOverLimit && (
          <div
            ...
            style={{
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.10) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, hsl(var(--surf-hue) 100% 20% / 0.96), hsl(var(--surf-hue) 100% 13% / 0.99))",
              borderColor: "rgba(118,228,247,0.30)",
              backdropFilter: "blur(5px) saturate(170%)",
              WebkitBackdropFilter: "blur(5px) saturate(170%)",
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.10), inset 0 0 34px -24px rgba(118,228,247,0.20), 0 0 22px -10px rgba(118,228,247,0.14), 0 20px 46px -28px rgba(0,0,0,0.72)",
            }}
        ...
        {isApproachingLimit && (
          <div
            ...
            style={{
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.09) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, hsl(var(--surf-hue) 100% 19% / 0.96), hsl(var(--surf-hue) 100% 12% / 0.99))",
              borderColor: "rgba(118,228,247,0.26)",
              backdropFilter: "blur(5px) saturate(170%)",
              WebkitBackdropFilter: "blur(5px) saturate(170%)",
              boxShadow:
                "inset 0 1px 0 rgba(255,255,255,0.10), inset 0 0 32px -24px rgba(118,228,247,0.18), 0 0 20px -10px rgba(118,228,247,0.12), 0 20px 46px -28px rgba(0,0,0,0.72)",
            }}
