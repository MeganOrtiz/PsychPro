      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 pt-4 md:pt-6 lg:pt-8 pb-4 md:pb-6 lg:pb-8">
        {isOverLimit && (
          <div
            ...
            style={{
              background:
                "linear-gradient(145deg, hsl(var(--surf-hue) 90% 20% / 0.96), hsl(var(--surf-hue) 90% 13% / 0.99))",
        ...
        {isApproachingLimit && (
          <div
            ...
            style={{
              background:
                "linear-gradient(145deg, hsl(var(--surf-hue) 90% 19% / 0.96), hsl(var(--surf-hue) 90% 12% / 0.99))",
