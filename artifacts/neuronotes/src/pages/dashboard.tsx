      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-6 lg:px-8 pt-4 md:pt-6 lg:pt-8 pb-4 md:pb-6 lg:pb-8">
        {isOverLimit && (
          <div
            ...
            style={{
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.16) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, hsl(var(--surf-hue) 98% 19% / 0.83), hsl(var(--surf-hue) 98% 14% / 0.90))",
        ...
        {isApproachingLimit && (
          <div
            ...
            style={{
              background:
                "radial-gradient(125% 80% at 50% 0%, rgba(118,228,247,0.14) 0%, rgba(118,228,247,0.00) 58%), linear-gradient(145deg, hsl(var(--surf-hue) 98% 19% / 0.79), hsl(var(--surf-hue) 98% 14% / 0.90))",
            ...
            <StudySurface tone="light" noGlow innerClassName="p-5">
              ...
              {isLoading ? (
                ...
                <div>
                  ...
                  <div className="h-2 rounded-full overflow-hidden mb-4" style={{ background: "hsl(var(--surf-hue) 88% 48% / 0.14)" }}>
                    <div
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={activitySeries} margin={{ top: 8, right: 8, bottom: 0, left: -22 }}>
                    ...
                    <Tooltip
                      ...
                      contentStyle={{
                        background: "hsl(var(--surf-hue) 100% 24% / 0.92)",
                  ...
                  <div
                    ...
                    style={
                      a.earned
                        ...
                        : {
                            background: "hsl(var(--surf-hue) 100% 24% / 0.4)",
                    ...
                    <div
                      ...
                      style={
                        a.earned
                          ...
                          : {
                              background: "hsl(var(--surf-hue) 79% 58% / 0.10)",
  ...
  return (
    <StudySurface tone="dark" noGlow fillHeight className="w-full" innerClassName="relative overflow-hidden p-7 text-white flex flex-col">
      ...
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(180deg, hsl(var(--surf-hue) 97% 14% / 0.26) 0%, hsl(var(--surf-hue) 97% 14% / 0.44) 55%, hsl(var(--surf-hue) 97% 14% / 0.66) 100%), url(${smokeBg})`,
