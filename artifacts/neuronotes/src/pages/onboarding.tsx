                  ...
                  style={{
                    background:
                      i < idx
                        ...
                        : i === idx
                          ? `${P.mist}`
                          : "rgba(var(--pp-ocean-deep-rgb), 0.14)",
                  }}
                />
              ))}
            </div>
...
.ob-grid-glow {
  ...
  mask-image: radial-gradient(ellipse 70% 60% at 50% 45%, var(--pp-floor) 25%, transparent 75%);
  -webkit-mask-image: radial-gradient(ellipse 70% 60% at 50% 45%, var(--pp-floor) 25%, transparent 75%);
}
...
.ob-brand-icon {
  ...
  background: ${P.surf};
  color: ${P.ink};
  box-shadow: 0 8px 22px -10px ${P.surf}aa, inset 0 1px 0 rgba(var(--pp-white-rgb),0.3);
  animation: ob-icon-pulse 4s ease-in-out infinite;
}
@keyframes ob-icon-pulse {
  0%,100% { box-shadow: 0 8px 22px -10px ${P.surf}aa, inset 0 1px 0 rgba(var(--pp-white-rgb),0.3); }
  50% { box-shadow: 0 8px 30px -8px ${P.surf}, inset 0 1px 0 rgba(var(--pp-white-rgb),0.4); }
}
...
.ob-card {
  ...
  border-radius: 20px;
  overflow: hidden;
  background: hsl(var(--surf-hue) var(--surf-sat) 25% / 0.66);
  border: 1px solid rgba(var(--pp-cyan-rgb),0.26);
  box-shadow:
    inset 0 1px 0 rgba(var(--pp-white-rgb),0.12),
    0 30px 70px -34px rgba(var(--pp-black-rgb),0.7),
...
.ob-title {
  ...
  text-shadow: 0 1px 2px rgba(var(--pp-black-rgb),0.25);
}
...
.ob-tile {
  ...
  background: hsl(var(--surf-hue) var(--surf-sat) 11% / 0.6);
  color: rgb(var(--pp-white-rgb));
  transition: transform .15s ease, border-color .15s ease, background .15s ease, box-shadow .15s ease;
}
.ob-tile:hover { transform: translateY(-1px); border-color: rgba(var(--pp-cyan-rgb),0.4); }
.ob-tile--on {
  border-color: ${P.surf};
  background: hsl(var(--surf-hue) var(--surf-sat) 25% / 0.78);
  box-shadow: inset 0 0 0 1px rgba(var(--pp-cyan-rgb),0.4), 0 0 26px -12px ${P.surf}cc;
}
.ob-tile-icon {
  display: inline-flex; align-items: center; justify-content: center;
...
.ob-tile-label { flex: 1; min-width: 0; font-size: 0.875rem; font-weight: 600; color: rgb(var(--pp-white-rgb)); }
...
.ob-actions button {
  ...
  background-color: hsl(var(--surf-hue) var(--surf-sat) 32% / 0.92) !important;
  border: 1px solid rgba(var(--pp-cyan-rgb),0.42) !important;
  color: ${PP.paperWhite} !important;
  box-shadow:
    inset 0 1px 0 rgba(var(--pp-white-rgb), 0.07) !important;
}
.ob-actions button:hover:not(:disabled) {
  background-color: hsl(var(--surf-hue) var(--surf-sat) 39% / 0.96) !important;
  border-color: rgba(var(--pp-cyan-rgb),0.6) !important;
  box-shadow:
    0 0 22px rgba(var(--pp-bright-rgb),0.32),
    inset 0 1px 0 rgba(var(--pp-white-rgb), 0.09) !important;
}
.ob-actions button:disabled { opacity: 0.5; }
.ob-check {
  display: inline-flex; align-items: center; justify-content: center;
  width: 20px; height: 20px; border-radius: 999px; flex-shrink: 0;
  background: ${P.surf}; color: ${P.ink};
}
.ob-check:empty { background: transparent; }
.ob-check--box { border-radius: 6px; }
.ob-check--box:empty { box-shadow: inset 0 0 0 1.5px rgba(var(--pp-cyan-rgb),0.4); }
...
.ob-row:hover { transform: translateY(-1px); border-color: rgba(var(--pp-cyan-rgb),0.4); }
...
.ob-plan {
  ...
  border: 1px solid rgba(var(--pp-cyan-rgb),0.18);
  background: hsl(var(--surf-hue) var(--surf-sat) 11% / 0.66);
  transition: transform .15s ease, border-color .15s ease, box-shadow .15s ease;
}
.ob-plan:hover { transform: translateY(-2px); border-color: rgba(var(--pp-cyan-rgb),0.42); }
.ob-plan--on {
  border-color: ${P.surf};
  box-shadow: inset 0 0 0 1px rgba(var(--pp-cyan-rgb),0.45), 0 0 32px -14px ${P.surf}cc;
}
.ob-plan--eppp {
  border-color: rgba(var(--pp-icy-rgb),0.4);
  background: hsl(var(--surf-hue) var(--surf-sat) 17% / 0.82);
}
.ob-plan--eppp.ob-plan--on {
  box-shadow: inset 0 0 0 1px rgba(var(--pp-icy-rgb),0.6), 0 0 38px -12px rgba(var(--pp-icy-rgb),0.7);
}
.ob-plan-badge {
...
.ob-plan-icon {
  display: inline-flex; align-items: center; justify-content: center;
  width: 32px; height: 32px; border-radius: 9px; flex-shrink: 0;
  background: ${P.teal}; color: ${P.cloud};
}
.ob-plan-icon--eppp { background: ${P.mist}; color: ${P.ink}; }
...
.ob-onetime {
  ...
  background: hsl(var(--surf-hue) var(--surf-sat) 17% / 0.78);
}
...
.ob-onetime-opt {
  ...
  background: hsl(var(--surf-hue) var(--surf-sat) 11% / 0.62);
  transition: transform .15s ease, border-color .15s ease, box-shadow .15s ease;
}
.ob-onetime-opt:hover { transform: translateY(-1px); border-color: rgba(var(--pp-icy-rgb),0.45); }
.ob-onetime-opt--on {
  border-color: ${P.mist};
  box-shadow: inset 0 0 0 1px rgba(var(--pp-icy-rgb),0.6), 0 0 30px -14px rgba(var(--pp-icy-rgb),0.7);
}
