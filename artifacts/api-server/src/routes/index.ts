...
import epppPurchaseRouter from "./eppp-purchase";
import epppStudyPlanRouter from "./eppp-study-plan";
...
router.use(epppPurchaseRouter);
router.use(epppStudyPlanRouter);
